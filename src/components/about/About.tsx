...
//                 About <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-pink-600">CareConnect</span>
//               </h1>
//             </div>
//             <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
//               For over 15 years, CareConnect has been Kenya's leading healthcare provider, 
//               dedicated to delivering exceptional medical care with compassion, innovation, 
//               and unwavering commitment to patient wellbeing.
//             </p>
//           </div>
...
//                   quality of life for our patients and communities. We are committed to 
//                   delivering personalized care through innovation, excellence, and a 
//                   patient-centered approach that treats every individual with dignity and respect.
//                 </p>
//               </div>
//             </div>
...
//                 </div>
//                 <p className="text-gray-700 leading-relaxed text-lg">
//                   To be East Africa's most trusted and innovative healthcare institution, 
//                   setting the standard for medical excellence, patient safety, and 
//                   community health. We envision a future where quality healthcare is 
//                   accessible to all, powered by cutting-edge technology and delivered 
...
//                 <p>
//                   CareConnect was founded in 2009 by a group of passionate medical professionals 
//                   who shared a common vision: to transform healthcare delivery in Kenya. What 
//                   started as a small clinic in Nairobi has grown into one of East Africa's 
//                   most respected healthcare institutions.
//                 </p>
//                 <p>
...
//                   telemedicine services, we have consistently been at the forefront of 
//                   healthcare technology adoption.
//                 </p>
//                 <p>
//                   Today, we serve over 50,000 patients annually across multiple specialties, 
//                   supported by a team of 200+ medical professionals. Our commitment to 
//                   excellence has earned us numerous accolades and, more importantly, the 
...
//               <div key={index} className="text-center p-6 rounded-2xl hover:shadow-lg transition-shadow bg-gray-50">
//                 <div className="flex justify-center mb-4">
//                   <div className="bg-gradient-to-r from-teal-100 to-pink-100 p-4 rounded-full">
...
//                   <p className="text-gray-600 text-sm mb-3">{leader.specialization} • {leader.experience}</p>
...
//               <div key={index} className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all">
//                 <div className="flex justify-center mb-4">
...
//                 <p className="text-gray-600">200+ specialists with international training and certifications</p>
//               </div>
//             </div>
...
//                 <p className="text-gray-600">State-of-the-art medical equipment and AI-powered diagnostics</p>
//               </div>
//             </div>
...
//                 <p className="text-gray-600">JCI accredited with highest safety and quality standards</p>
//               </div>
//             </div>
...
//                 <p className="text-gray-600">Patient-centered approach with personalized treatment plans</p>
//               </div>
//             </div>
...
//                 <p className="text-gray-600">ISO certified with international quality management systems</p>
//               </div>
//             </div>
//           </div>
//         </div>
